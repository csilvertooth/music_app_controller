...
async def async_setup_entry(
    ...
    def _on_airplay_devices(device_data: list[dict]) -> None:
        ...
        # Update availability and state for existing players
        ...
        for player_name, player in airplay_players.items():
            ...
            if player_data:
                # Update availability based on whether device is in the list
                player._available = (player_name in names)  # type: ignore
...
class AppleMusicAirPlayPlayer(MediaPlayerEntity):
    ...
    def _on_airplay_update(self, device_data: list[dict]) -> None:
        ...
        if player_data:
            # Update status
            self._available = player_data.get('active', False)
