class MusicNowPlayingCard extends HTMLElement {
    ...
    connectedCallback() {
        ...
        (_b = this._root.querySelector('#playpause')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => this._svc('media_play_pause'));
        (_c = this._root.querySelector('#next')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => this._svc('media_next_track'));
        (_d = this._root.querySelector('#shuffle')) === null || _d === void 0 ? void 0 : _d.addEventListener('click', () => this._toggleShuffle());
        (_e = this._root.querySelector('#mvDown')) === null || _e === void 0 ? void 0 : _e.addEventListener('click', () => this._bumpVol(-0.1));
        (_f = this._root.querySelector('#mvUp')) === null || _f === void 0 ? void 0 : _f.addEventListener('click', () => this._bumpVol(0.1));
        (_g = this._root.querySelector('#masterVol')) === null || _g === void 0 ? void 0 : _g.addEventListener('input', (e) => this._setVol(parseFloat(e.target.value)));
        (_h = this._root.querySelector('#openBrowseNP')) === null || _h === void 0 ? void 0 : _h.addEventListener('click', () => this._showBrowseNP());
        (_j = this._root.querySelector('#browseCloseNP')) === null || _j === void 0 ? void 0 : _j.addEventListener('click', () => this._hideBrowseNP());
    }
    ...
    async _updateDeviceSelection(attrs) {
        const deviceListEl = this._root.querySelector('#deviceList');
        if (!deviceListEl || !this._hass)
            return;
        const available = attrs.available_devices || [];
        const selected = attrs.selected_devices || [];
        ...
        available.forEach(device => {
            ...
            checkbox.addEventListener('change', (e) => {
                ...
                (_a = this._hass) === null || _a === void 0 ? void 0 : _a.callService('apple_music', 'set_selected_airplay_devices', { devices: newSelected });
            });
